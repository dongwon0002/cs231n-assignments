...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    logits_real = bce_loss(logits_real, torch.ones_like(logits_real).reshape(-1))
    logits_fake = bce_loss(logits_fake, torch.zeros_like(logits_fake).reshape(-1))
...
def generator_loss(logits_fake):
    ...
    loss = None
    # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    loss = bce_loss(logits_fake, torch.ones_like(logits_fake).reshape(-1))
    pass
